    ...
    <>
        <div className="StudentMainDiv p-4">
          <div className='w-75 d-block mx-auto bg-light shadow-lg rounded-4 p-4'>
            ...
            <img style={{height:"100px", width: '100px', display: 'inline', borderRadius: '50%'}} src={`${studentInfo.pictureUrl.split('upload/')[0]}upload/r_max,q_50/${studentInfo.pictureUrl.split('upload/')[1]}`} alt="" />
