    ...
    <>
        <form className='w-100' onSubmit={formik.handleSubmit}>
          ...
          <div className='w-100 px-4'>
            ...
            <input disabled name='setting' type='link'  {...formik.getFieldProps('twitterlink')} className='form-control w-50 d-block' placeholder='Email Address' id='twitterlink' />
            <div name='setting' className='d-block w-50 ms-auto'>
                <label htmlFor='facebooklink'>Facebook Link</label>
                <input disabled type='link'  {...formik.getFieldProps('facebooklink')} className='form-control' placeholder='Facebook Link' id='facebooklink' />
            </div>
            <label htmlFor='whatsappNumber'>WhatsApp Number</label>
            <input disabled type='tel' name='setting'  {...formik.getFieldProps('whatsapplink')} className='form-control w-50 d-block' placeholder='WhatsApp Link' id='whatsapplink' />
            <div name='setting' className='d-block w-50 ms-auto'>
                <label htmlFor='otherLinks'>Other Link</label>
                <input disabled type='link'  {...formik.getFieldProps('otherlink')} className='form-control' placeholder='Other Link' id='otherlink' />
            </div>
