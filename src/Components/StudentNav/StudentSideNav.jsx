...
const StudentSideNav = () => {
  return (
    <>
        <div id="mySidenav" className="sidenav responsive text-center d-flex w-100 px-5">
            ...
            <span id='openPop' className='p-2 rounded-3 border border-2 border-light'><i className='fas fa-bars text-light'></i></span>
        </div>
    </>
  )
}
